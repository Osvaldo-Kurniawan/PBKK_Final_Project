	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="<?= base_url('admin/manager') ?>">Kelola manager</a></li>
				<li class="breadcrumb-item active">Tambah/Ubah manager</li>
			</ol>
		</div>
	</div>
	<!-- row -->
		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					...
					<h6 class="card-subtitle">Data manager ini akan sekaligus membuat akun otomatis, dengan password sesuai tanggal lahir. </h6>
					<hr>

...
<head>
	...
	<link href="<?= base_url() ?>assets/template/adminwrap/horizontal/css/colors/blue-dark.css" id="theme" rel="stylesheet">
</head>

<body class="card-no-border">
	<!-- Memanggil file php di manager/components/preloadder.php -->
	<?php $this->load->view('manager/components/preloadder') ?>
	<div id="main-wrapper">
		<!-- Memanggil file php di manager/components/header.php -->
		<?php $this->load->view('manager/components/header') ?>
		<!-- Memanggil file php di manager/components/sidebar.php -->
		<?php $this->load->view('manager/components/sidebar') ?>
		<!-- Content -->
		<div class="page-wrapper">
			<!-- Memanggil varible viewUtama dari method controller -->
			<?php $this->load->view($viewUtama) ?>
			<!-- Memanggil file php di manager/components/footer.php -->
			<?php $this->load->view('manager/components/footer') ?>
		</div>
	</div>
